...
control 'cis-dil-benchmark-1.4.1' do
  ...
  describe.one do
    %w(/boot/grub2/grub.conf /boot/grub2/grub.cfg /boot/grub2/menu.lst /boot/boot/grub2/grub.conf /boot/boot/grub2/grub.cfg /boot/boot/grub2/menu.lst /boot/grub2/grub.cfg).each do |f|
      describe file(f) do
        it { should exist }
