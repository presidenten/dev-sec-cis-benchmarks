...
control 'cis-dil-benchmark-4.1.3' do
  ...
  describe.one do
    %w(/boot/grub2/grub.conf /boot/grub2/grub.cfg /boot/grub2/menu.lst /boot/boot/grub2/grub.conf /boot/boot/grub2/grub.cfg /boot/boot/grub2/menu.lst /boot/grub2/grub.cfg /usr/share/oem/grub.cfg).each do |f|
      describe file(f) do
